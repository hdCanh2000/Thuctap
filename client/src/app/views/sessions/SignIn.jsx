          ...
          <Card className="signup-card position-relative y-center">
            <Grid container>
              <Grid item lg={5} md={5} sm={5} xs={12}>
                <div className="p-32 flex-center center flex-middle h-100">
                  <img
                    className="mgn_top"
                    src="https://i.pinimg.com/564x/36/b0/a0/36b0a084544360c807d7c778358f762d.jpg"
                    alt=""
                  />
                  <h4 className="bold line_height">{t("web_site")}</h4>
                </div>
              </Grid>
              <Grid item lg={7} md={7} sm={7} xs={12}>
                <div className="p-36 h-100 bg-light-gray position-relative">
                  <h4 className="center mgn_bot line_height">
                    {t("Dashboard.login")} hệ thống
                  </h4>
